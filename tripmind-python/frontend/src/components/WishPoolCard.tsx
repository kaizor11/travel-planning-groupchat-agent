...
export default function WishPoolCard({ message, tripId, currentUserId }: WishPoolCardProps) {
  ...
  const handleSkip = () => {
    setStatus('skipped')
    confirmWishpool(tripId, 'skip', pd.destination, pd.tags, null, null, currentUserId)
  }
